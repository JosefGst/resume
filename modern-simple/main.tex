...
\includegraphics[width=\textwidth]{Profilphoto.jpg}\hspace{1em}
\end{minipage}
\hfill
...
{\small
\faGraduationCap~ \underline{} Masters in Mechanical Engineering \\
...
% \faEnvelopeO~ jgstoettner@connect.ust.hk \\ 
% \faMapMarker~ Hong Kong \\
