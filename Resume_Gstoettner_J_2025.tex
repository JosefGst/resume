...
\address{ \url{https://github.com/JosefGst} \\ \url{https://josefgst.github.io/} \\ \href{https://www.linkedin.com/in/josef-gstoettner-437630172/}{linkedin}} % GitHub profile (optional)
...
\begin{rSection}{Laguanges}
	\begin{CJK*}{UTF8}{gbsn}
	\item German (native), English (fluent), Chinese Mandarin (汉语水平考试四级, intermediate)
	\end{CJK*}
\end{rSection}
