...
\begin{list}{$\cdot$}{\leftmargin=0em}\setlength{\itemsep}{-0.em} \vspace{-0.em}
    ...
    \item 4 years of experience working with single board computers (Raspberry Pi, Jetson)
\end{list}
\bigskip
...
\begin{tabular}{p{0.55\textwidth} c}
    \cvevent{2025/9--present}{Assistant Research Engineer}{ROS robot programming}{HKCRC | Sciences Park}{\vspace{-1.em}\begin{list}{$\cdot$}{\leftmargin=0em}\setlength{\itemsep}{-0.3em} \vspace{-0.5em}
        \item Develope autonomous, reliable tasks and recovery behaviors for a water tank cleaning robot using behavior trees.
        ...
        \item Create relalistic Gazebo simulations for faster iterations and testing.
