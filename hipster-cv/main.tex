...
\header{\bg{headerfontbox}{headerfontboxfont}{Robotics Engineer} }{\bgupper{headerfontbox}{headerfontboxfont}{\bfseries\Huge Josef Gstoettner}}{\bg{headerfontbox}{headerfontboxfont}{\large \faGraduationCap~ Masters in Mechanical Engineering}}{profile_cropt.png}{headerblue}{3.5cm}{2cm}
...
ROS / ROS 2 mobile robots ~•~ CAD / CAE %~•~ Parler
...
\begin{tabular}{r| p{0.4\textwidth} c}
    \cvevent{2022--2024}{System Engineer}{ROS}{LSCM\color{cvred}}{Set up SLAM (cartographer, slamtoolbox, rtabmap) and NAV2 on autonomous mobile robots.}{assets/LSCM.jpg} \\
...
\begin{tabular}{r| p{0.4\textwidth} c}
    \cvevent{2023}{Lingao ROS 2}{ROS 2}{Personal side Project}{Build an autonomous mobile robot from scratch for outdoor environment.}{assets/empty.png} \\
    ...
    \cvevent{2020--2021}{Autonomous RC-car race (first place \faTrophy)}{Imitation Learning}{HKUST \color{cvred}}{Trained Pytorch model on the Jetson Nano for autonomous-driving, obstacle avoidance and overtaking of other cars.}{assets/autorace.png}
\end{tabular}
...
\icon{\faGithub}{cvpurple}{} \protect\url{https://github.com/JosefGst} \\ 
