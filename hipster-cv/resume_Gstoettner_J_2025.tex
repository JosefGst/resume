...
\begin{tabular}{r| p{0.4\textwidth} c}
    \cvevent{2022/4--2024/8}{System Engineer}{ROS robot programming}{LSCM\color{cvred}}{- Set up SLAM (cartographer, slamtoolbox, rtabmap) and navigation on autonomous mobile robots.  \newline - Developed motor drivers and autonomous docking in C++ and Python. \newline - Experience with wide range of sensors (3D LiDAR, depth cameras, IMU, GPS, Sonar.).}{assets/LSCM.jpg} \\
    \cvevent{2020/7--2022/3}{Research Assistant}{Embedded Software}{HKUST \color{cvred}}{- Developed a weight scale with RFID scanner for automated storage records in chemical Labs on Arduino MCU. \newline - Firmware development on a low power IoT accelerometer with BLE Mesh for predictive maintenance based on Nrf52.}{assets/ust.png} \\
    \cvevent{2019/8--2020/4}{Mechanical Engineer}{CAD design}{KALBAS \color{cvred}}{- Designed, 3D-printed and created tool-paths for CNC machining of fish lure prototypes.}{assets/empty.png}
\end{tabular}
...
\begin{tabular}{r| p{0.4\textwidth} c}
    \cvevent{2023/8}{Lingao ROS 2}{ROS 2}{Personal side Project}{\faGithub~ \url{https://github.com/JosefGst/lingao_ros2} \newline Built an autonomous mobile robot from scratch for outdoor environment.}{assets/empty.png} \\
    \cvevent{2021/11--2022/4}{Red Bird Racing}{Autonomous Racing}{HKUST \color{cvred}}{Cone detection with OpenCV and autonomous race car control-algorithm in ROS}{assets/red_bird.png} \\
    \cvevent{2021/10--2022/4}{Robomaster}{Software team}{HKUST \color{cvred}}{SLAM and navigation for autonomous Robot in ROS and embedded software development on STM32.}{assets/robo_master.jpg} \\
    \cvevent{2020/12--2021/3}{Autonomous RC-car race (first place \faTrophy)}{Imitation Learning}{HKUST \color{cvred}}{\faGithub~ \protect\url{https://github.com/JosefGst/autorace} \newline Trained Pytorch model on the Jetson Nano for autonomous-driving, obstacle avoidance and overtaking of other cars.}{assets/autorace.png}
\end{tabular}
